...
public class ConfigurationHandler {
    ...
    private static void loadConfiguration() {
        ...
        Settings.General.syncThreshold = configuration.getInt(
        ...
        Settings.Sounds.soundMode = ConfigurationHelper.getString(
                configuration,
        ...
        Settings.Abilities.onlyLoadFile = configuration.getBoolean(
        ...
        Settings.DynamicEnergyValueGeneration.regenerateEnergyValuesWhen = ConfigurationHelper.getString(
                configuration,
                ...
                new String[] { "Never", "When Mods Change", "Always" },
