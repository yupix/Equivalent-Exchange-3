...
public class JsonFluidStack implements JsonSerializer<JsonFluidStack>, JsonDeserializer<JsonFluidStack> {
    ...
    public static final Gson jsonSerializer = (new GsonBuilder())
            .registerTypeAdapter(JsonFluidStack.class, new JsonFluidStack()).create();
    ...
    @Override
    public JsonFluidStack deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
