...
public class WrappedStack
        implements Comparable<WrappedStack>, JsonDeserializer<WrappedStack>, JsonSerializer<WrappedStack> {

    public static final Gson jsonSerializer = (new GsonBuilder()).setPrettyPrinting()
            .registerTypeAdapter(WrappedStack.class, new WrappedStack()).create();
        ...
        if (object instanceof ItemStack) {
            if (((ItemStack) object).getItem() != null) {
                ...
                ItemStack itemStack = new ItemStack(
                        itemStackObject.getItem(),
                        itemStackObject.stackSize,
                        itemStackObject.getItemDamage());
     ...
     * method to create objects for any non-trivial field of the returned object. However, you should never invoke it on
     * the the same type passing {@code jsonElement} since that will cause an infinite loop (Gson will call your
                ...
                if (objectType != null) {
                    if (objectType.equalsIgnoreCase("ItemStack")) {
                        JsonItemStack jsonItemStack = JsonItemStack.jsonSerializer
                                .fromJson(jsonWrappedStack.get("objectData"), JsonItemStack.class);
                        ...
                        JsonFluidStack jsonFluidStack = JsonFluidStack.jsonSerializer
                                .fromJson(jsonWrappedStack.get("objectData"), JsonFluidStack.class);
                        FluidStack fluidStack = new FluidStack(
                                jsonFluidStack.fluid,
                                jsonFluidStack.amount,
                                jsonFluidStack.tag);
     ...
     * JsonElements for any non-trivial field of the {@code wrappedStack} object. However, you should never invoke it on
     * the {@code wrappedStack} object itself since that will cause an infinite loop (Gson will call your call-back
     * method again).
     * </p>
     *
    ...
    public JsonElement serialize(WrappedStack wrappedStack, Type typeOfSrc, JsonSerializationContext context) {
        ...
        if (wrappedStack.wrappedStack instanceof ItemStack) {
            ...
            jsonItemStack.itemName = Item.itemRegistry
                    .getNameForObject(((ItemStack) wrappedStack.wrappedStack).getItem());
            ...
            jsonWrappedStack
                    .add("objectData", JsonItemStack.jsonSerializer.toJsonTree(jsonItemStack, JsonItemStack.class));
            ...
            jsonWrappedStack
                    .add("objectData", JsonFluidStack.jsonSerializer.toJsonTree(jsonFluidStack, JsonFluidStack.class));
        }
    ...
    /*
     * Sort order (class-wise) goes ItemStack, OreStack, EnergyStack, FluidStack, null
