...
public class CachedOreDictionary {
    ...
    private CachedOreDictionary() {
        ...
        Map<String, List<ItemStack>> nameToStackMap = new TreeMap<String, List<ItemStack>>(
                Comparators.stringComparator);
        Multimap<WrappedStack, String> stackToNameMultiMap = TreeMultimap
                .create(WrappedStack.comparator, Comparators.stringComparator);
