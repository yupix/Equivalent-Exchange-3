...
public class ContainerResearchStation extends ContainerEE {
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            /**
             * If we are shift-clicking an item out of the Research Table's container, attempt to put it in the first
             * available slot in the entityPlayer's inventory
             */
            if (slotIndex < TileEntityResearchStation.INVENTORY_SIZE) {
                ...
                /**
                 * If the stack being shift-clicked into the Research Table's container is a fuel, first try to put it
                 * in the fuel slot. If it cannot be merged into the fuel slot, try to put it in the input slot.
                 */
