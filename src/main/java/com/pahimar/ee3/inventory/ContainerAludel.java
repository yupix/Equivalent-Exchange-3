...
public class ContainerAludel extends ContainerEE {
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            /**
             * If we are shift-clicking an item out of the Aludel's container, attempt to put it in the first available
             * slot in the player's inventory
             */
            if (slotIndex < TileEntityAludel.INVENTORY_SIZE) {
                ...
                /**
                 * If the stack being shift-clicked into the Aludel's container is a fuel, first try to put it in the
                 * fuel slot. If it cannot be merged into the fuel slot, try to put it in the input slot.
                 */
                ...
                /**
                 * If the stack being shift-clicked into the Aludel's container is a dust, first try to put it in the
                 * dust slot. If it cannot be merged into the dust slot, try to put it in the input slot.
                 */
