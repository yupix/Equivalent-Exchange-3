...
public class ContainerAugmentationTable extends ContainerEE {
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            /**
             * If we are shift-clicking an item out of the AugmentationTable's container, attempt to put it in the first
             * available slot in the player's inventory
             */
            if (slotIndex < TileEntityAugmentationTable.INVENTORY_SIZE) {
                ...
                /**
                 * If the stack being shift-clicked into the AugmentationTable's container is a tool(?), first try to
                 * put it in the tool slot.
                 */
                ...
                /**
                 * If the stack being shift-clicked into the AugmentationTable's container is an augment(?), try to put
                 * it in the augment slot.
                 */
