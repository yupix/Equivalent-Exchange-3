...
public class Recipes {
    ...
    private static void initModRecipes() {
        ...
        GameRegistry.addShapedRecipe(
                new ItemStack(ModBlocks.chalkBlock),
                "bcb",
                "cbc",
                "bcb",
                'b',
        ...
        GameRegistry
                .addShapedRecipe(new ItemStack(ModBlocks.chalkBlock), "cc", "cc", 'c', new ItemStack(ModItems.chalk));
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(new ItemStack(ModItems.diviningRod), " s ", " s ", "s s", 's', "stickWood"));
